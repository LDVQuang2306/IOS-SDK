    ...
    namespace UtfImpl
{
    ...
    // wchar_t is a utf16 codepoint on windows, utf32 on linux/ios
...
template<
    ...
    {
        // Fixed: Was calling Utf32StringToUtf16String with utf8_iterator
    ...
    {
        // Fixed: Was calling Utf32StringToUtf16String with utf32_iterator on utf8 types
...
/*
    ...
    UTF_CONSTEXPR byte_iterator_type ReplaceUtf8(byte_iterator_type Begin, byte_iterator_type End, utf_cp8_t CharToReplace, utf_cp8_t ReplacementChar)
    {
        ...
        return End; // Added return to silence warnings
    }
    ...
    // utf_char spezialization-implementation for Utf16
